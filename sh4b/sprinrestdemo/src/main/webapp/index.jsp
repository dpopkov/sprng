...
<p><a href="${pageContext.request.contextPath}/api/students/123">api/students/123</a> (not found id)</p>
<p><a href="${pageContext.request.contextPath}/api/students/abc">api/students/abc</a> (bad request)</p>
