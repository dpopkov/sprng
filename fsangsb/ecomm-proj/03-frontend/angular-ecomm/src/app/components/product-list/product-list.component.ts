...
export class ProductListComponent implements OnInit {
  ...
  handleListProducts() {
    ...
    // Check if we ahve a different category than the previous
    // Note: Angular will reuse a component if it is currently being used.
    // If we have a different catgory id than the previous
  ...
  addToCart(theProduct: Product) {
    console.log(`theProduct name=${theProduct.name} unitPrice=${theProduct.unitPrice}`);
  }
}
